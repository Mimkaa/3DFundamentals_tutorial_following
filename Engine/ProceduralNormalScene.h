...
#include "Mat3.h"
#include "Pipeline.h"
#include "ProceduralNormalEffect.h"


class ProceduralNormalScene : public Scene
{
public:
	typedef Pipeline<ProceduralNormalEffect> Pipeline;
	typedef Pipeline::Vertex Vertex;
public:
	ProceduralNormalScene(Graphics& gfx, IndexedTriangleList<Vertex> tl)
		:
		itlist(std::move(tl)),
		pipeline(gfx)
